...
const NewLandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Streak Reset Notice - Top Banner */}
      <div className="bg-orange-100 border-b border-orange-200 px-4 py-3">
        <div className="max-w-7xl mx-auto">
          <p className="text-orange-800 text-sm text-center flex items-center justify-center">
            <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <strong>Notice:</strong>  Existing users’ streaks have been reset due to technical issues. Your learning progress is unaffected. Thank you for using PracticeQs.
          </p>
        </div>
      </div>
